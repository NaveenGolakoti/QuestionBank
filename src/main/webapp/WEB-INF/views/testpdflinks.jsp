...
<h2 style="text-align:center;">Download Tests</h2>
 <hr style="height:1px;border:none;color:#333;background-color:#333;">
  <c:choose>
  <c:when test="${fn:length(list) > 0 }">
<c:forEach var="links" items="${list}">  
<a style="margin-left:400px;font-size:x-large;"href="downloadPdf?type=test&typeNumber=${links}">test${links}</a> <br><br>
</c:forEach>
 </c:when>
  <c:otherwise>
